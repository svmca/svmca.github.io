    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <div class="nav navbar-nav navbar-right loginstyle">
        <div class="nav-login">
          ...
          if (isset($_SESSION['u_id'])) {
            echo '<form action="includes/logout.inc.php" method="POST">
              <button type="submit" name="submit" class="btn-warning btm-sm">Logout</button>
            </form>';
          }
          //Logged out
          else {
       ...
       <!--  <form action="includes/login.inc.php" method="POST">
          ...
          <input type="password" name="pwd" placeholder="Password">
          <button type="submit" name='submit' class="btn-warning btn-sm">Login</button>
          <a type="btn" href="signup.php" class="btn-warning btn-sm" ><i class="fas fa-paw"></i> Sign up</a>
        </form> -->
      </div>
    </div><!-- /.navbar-collapse -->
...
<div class="row">
  ...
  <div class="col-lg-4 col-sm-6 col-xs-12">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>Donate</h3>
        <p><a href="support.php#donate" class="btn btn-warning" role="button">Options</a> </p>
      </div>
    </div>
  </div>
</div>
